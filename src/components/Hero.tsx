    ...
    <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-base md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
        ...
        >
          <button
            className="group bg-k8s-blue hover:bg-blue-600 text-white px-4 py-3 md:px-8 md:py-4 rounded-lg font-semibold text-base md:text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl flex items-center"
            onClick={() => window.location.href = 'https://rzp.io/rzp/pPLy6W4x'}
          >
          ...
          <button
            className="group bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white px-4 py-3 md:px-8 md:py-4 rounded-lg font-semibold text-base md:text-lg transition-all duration-300 border border-white/20 flex items-center"
        ...
        <motion.div
          ...
          className="mt-12 md:mt-16 flex flex-row justify-between gap-4 md:grid md:grid-cols-3 md:gap-8 max-w-4xl mx-auto"
        >
          {[
            ...
            <div key={index} className="text-center flex-1">
              ...
              <div className="text-white font-semibold text-base md:text-lg">{stat.label}</div>
              <div className="text-white text-xs md:text-sm">{stat.sublabel}</div>
            </div>
          ))}
        </motion.div>
      </div>
